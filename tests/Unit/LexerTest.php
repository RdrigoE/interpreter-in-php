...
class LexerTest extends TestCase
{
	...
	public static function lexerProvider(): array
	{
		return [
			...
			'next_token_with_conditionals_returns' => [
				"let five = 5; let ten = 10; let add = fn(x, y) { x + y; }; let result = add(five, ten); !-/*5; 5 < 10 > 5; if (5 < 10) { return true; } else { return false; }",
				[
					[TokenType::LET, "let"],
					[TokenType::IDENT, "five"],
					[TokenType::ASSIGN, "="],
